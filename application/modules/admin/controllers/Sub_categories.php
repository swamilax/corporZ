...
class Sub_categories extends Admin_Base_Controller
{
    ...
    public function index()
    {
        try {
            ...
            $crud = $this->getGroceryCRUD('subcategories', 'Subcategories', 'Manage Subcategories', 'Manage Subcategories');

            // data Grid view fields
            $crud->columns('pid', 'catname', 'link', 'sort', 'file_path', 'created');

            // Insert form
            $crud->add_fields('pid', 'catname', 'link', 'sort', 'file_path');

            // Update form
            $crud->edit_fields('pid', 'catname', 'link', 'sort', 'file_path');

            //File upload
            $crud->set_field_upload('file_path', 'assets/frontend/images/categories');

            // Required fields
            $crud->required_fields('catname', 'link', 'sort', 'file_path');
